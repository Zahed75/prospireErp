...
INSTRUCTOR_HTML = "<div class=\"prospire-course-instructor\">\n  <h3>Course Instructor</h3>\n  <div class=\"prospire-instructor-card\" style=\"display:flex;gap:24px;align-items:flex-start;flex-wrap:wrap;\">\n    <div class=\"prospire-instructor-avatar\" style=\"width:96px;height:96px;border-radius:50%;background:linear-gradient(135deg,#6D28D9,#9333EA);color:#fff;display:flex;align-items:center;justify-content:center;font-size:40px;font-weight:700;flex-shrink:0;\">ZH</div>\n    <div style=\"flex:1;min-width:260px;\">\n      <h4 style=\"margin-top:0;\">Zahed Hasan — Odoo Technical Trainer</h4>\n      <p>Engineering Manager and ERP architect with 5+ years delivering custom Odoo solutions (v17–19) for retail, logistics, manufacturing, and trade-finance. Currently leading the Fair Group (Secret Recipe) Odoo 19 on-premises implementation — multi-level BoM manufacturing, purchase automation, and multi-branch inventory.</p>\n      <p>Zahed has built Bangladesh Bank-compliant LC modules, cut operational costs 30% through automation, and mentors developers from first module to production deployment.</p>\n      <p style=\"margin-bottom:0;\"><a href=\"https://thezhasan.com\" target=\"_blank\">thezhasan.com</a></p>\n    </div>\n  </div>\n</div>"

CHANNEL_DESCRIPTION_HTML = CHANNEL_DESCRIPTION_HTML + INSTRUCTOR_HTML

...
class TestPayslipValidation(TestPayslipValidationCommon):
    ...
    def test_regular_payslip_subsidy(self):
        ...
        payslip = self._generate_payslip(date(2025, 2, 1), date(2025, 2, 15))
        payslip_results = {'BASIC': 10000.0, 'HOLIDAY_TO_SUB': 0.0, 'GROSS_WITHOUT_HOLIDAY': 10000.0, 'HOLIDAYS_ON_TIME': 0.0, 'SAVINGS_FUND_SALARY_LIMIT': 1300.0, 'SAVINGS_FUND_LIMIT_UMA': 2235.65, 'SAVINGS_FUND_EMPLOYER_ALW': 1300.0, 'GROSS': 10000.0, 'ISR': -1312.94, 'SAVINGS_FUND_EMPLOYEE': -1300.0, 'SAVINGS_FUND_EMPLOYER_DED': -1300.0, 'SUBSIDY': 234.2, 'SUBSIDY_CURRENT_MONTH': 234.2, 'SUBSIDY_NEXT_MONTH': 0.0, 'INT_DAY_WAGE_BASE': 702.28, 'INT_DAY_WAGE_OTHER': 0.0, 'INT_DAY_WAGE_COMMISSIONS': 0.0, 'INT_DAY_WAGE': 702.28, 'RISK_IMSS_EMPLOYER': 52.67, 'DIS_FIX_IMSS_EMPLOYER': 346.21, 'DIS_ADD_IMSS_EMPLOYER': 59.87, 'DIS_ADD_IMSS_EMPLOYEE': -21.77, 'DIS_MED_IMSS_EMPLOYER': 110.61, 'DIS_MED_IMSS_EMPLOYEE': -39.5, 'DIS_MON_IMSS_EMPLOYER': 73.74, 'DIS_MON_IMSS_EMPLOYEE': -26.34, 'DIS_LIF_IMSS_EMPLOYER': 184.35, 'DIS_LIF_IMSS_EMPLOYEE': -65.84, 'RETIRE_IMSS_EMPLOYER': 210.68, 'CEAV_IMSS_EMPLOYER': 676.51, 'CEAV_IMSS_EMPLOYEE': -118.51, 'NURSERY_IMSS_EMPLOYER': 105.34, 'INFONAVIT_IMSS_EMPLOYER': 526.71, 'IMSS_EMPLOYEE_TOTAL': 271.96, 'IMSS_EMPLOYER_TOTAL': 2346.7, 'NET': 7349.3, 'PROVISIONS_CHRISTMAS_BONUS': 1260.27, 'PERIOD_PROVISIONS_CHRISTMAS_BONUS': 1260.27, 'PROVISIONS_HOLIDAY_BONUS': 2136.99, 'PERIOD_PROVISIONS_HOLIDAY_BONUS': 2136.99, 'PROVISIONS_VACATIONS_BONUS': 8547.95, 'PERIOD_PROVISIONS_VACATIONS_BONUS': 8547.95}
        self._validate_payslip(payslip, payslip_results)
